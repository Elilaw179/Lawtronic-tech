      ...
      <div className="mx-auto max-w-7xl px-5 py-14 md:px-6 md:py-16">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5">
              <div className="h-10 w-10 rounded-full overflow-hidden ring-2 ring-circuit/30 shadow-glow-sm shrink-0">
                <img src="/logo2.png" alt="" className="logo-blend h-full w-full object-cover" />
              </div>
        ...
        <div className="flex flex-col items-center gap-5 sm:flex-row sm:justify-between">
          <p className="text-xs text-ink-muted">
            &copy; {new Date().getFullYear()} Lawtronic Technologies Ltd. All rights reserved.
          </p>
