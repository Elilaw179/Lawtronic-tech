...
const WHY_LAWTRONIC = [
  ...
  { title: 'Practical Innovation', detail: 'We focus on solving real problems rather than technology for technology’s sake.' },
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-20 sm:py-28 md:py-36 md:px-6">
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                LAWTRONIC TECHNOLOGIES LTD • Innovate • Automate • Elevate
              </p>
              <h1
